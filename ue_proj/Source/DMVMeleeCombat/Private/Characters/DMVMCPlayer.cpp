...
void ADMVMCPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADMVMCPlayer::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADMVMCPlayer::Look);
	}
	else
	{
...
void ADMVMCPlayer::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADMVMCPlayer::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
